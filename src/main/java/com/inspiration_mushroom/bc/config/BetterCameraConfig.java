...
public final class BetterCameraConfig {
    ...
    static {
        ...
        APPLY_POSITION_DAMPING = builder
                .comment("Applies target-follow damping to the third-person camera position.")
        ...
        CHASE_RESPONSE_TIME = builder
                ...
                .defineInRange("chaseResponseTime", 0.2D, 0.05D, 0.8D);
        ...
        CHASE_RESPONSE_WEIGHT = builder
                ...
                .defineInRange("chaseResponseWeight", 0.3D, 0.0D, 1.0D);
        POSITION_RESPONSE_TIME = builder
                .comment("Camera-position 95% response time in seconds. Higher values create more spatial follow lag.")
                .defineInRange("positionResponseTime", 0.24D, 0.02D, 0.6D);
